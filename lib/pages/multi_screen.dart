...
import 'package:multi_quzi/pages/home_page.dart';
...
class _MultiScreenState extends State<MultiScreen> {
  ...
  int questionCount = 0;
  int iquestionCount = 10;
  @override
  void initState() {
    Timer.periodic(Duration(seconds: 1), (timer) {
      setState(() {
        iquestionCount--;
        if(iquestionCount==0)timer.cancel();
      });
    });
    super.initState();
  }
                  ...
                  Stack(alignment: Alignment.center, children: [
                    SizedBox(
                      ...
                      child: CircularProgressIndicator(
                        value: iquestionCount/10,
                        color: Colors.white,
                        backgroundColor: Colors.white12,
                      ),
                    ),
                    Text(
                     iquestionCount<1?"":iquestionCount.toString(),
                      style: TextStyle(
